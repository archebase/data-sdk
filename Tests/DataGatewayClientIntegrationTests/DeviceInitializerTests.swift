...
@Test func initDeviceWritesConfigAfterRemoteSuccess() async throws {
    ...
    #expect(await transport.requests() == [DeviceInitRequestRecord(deviceID: "260427-000001", sdkVersion: "1.2.3", platform: "ios-simulator")])
}
...
private actor RecordingDeviceInitTransport: DeviceInitTransport {
    ...
    func initDevice(
        ...
        self.records.append(DeviceInitRequestRecord(deviceID: deviceID, sdkVersion: sdkVersion, platform: platform))
